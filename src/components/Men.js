...
import product1 from '../assets/product1.jpeg'; // Updated to .jpeg
import product2 from '../assets/product2.jpeg'; // Updated to .jpeg
import product3 from '../assets/product3.jpeg'; // Updated to .jpeg

const Men = () => {
  return (
    <div className="flex flex-col items-center justify-center p-4 bg-gray-100 min-h-screen fade-in">
      <h2 className="text-3xl font-bold mb-6">Men's Section</h2>
      <p className="mb-4">Here you can find all products for men.</p>
